...
def load_data(database_filepath):
    ...
    """
    engine = create_engine(f'sqlite:///DisasterResponseTT.db')
...
def build_model():
    ...
    Returns:
    cv: GridSearchCV object. Machine learning model after performing grid search.
    """
    pipeline = Pipeline([
...
def main():
    ...
    if len(sys.argv) == 3:
        ...
        print('Please provide the filepath of the disaster response database '              'as the first argument and the filepath of the pickle file to '              'save the model to as the second argument. \n\nExample: python '              'train_classifier.py ../data/DisasterResponse.db classifier.pkl')
